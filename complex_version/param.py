...
# -- Learning --
parser.add_argument('--query_template_limit', type=int, default=2,
                    help='max number of query templates')
parser.add_argument('--query_dim', type=int, default=5,
                    help='query template dimensions')
parser.add_argument('--block_limit', type=int, default=5,
                    help='max number of data blocks')
parser.add_argument('--block_based_query_dim', type=int, default=3,
                    help='block_based query dim')
parser.add_argument('--block_dim', type=int, default=5,
                    help='block dimensions')
parser.add_argument('--candidate_dim', type=int, default=3,
                    help='candidate input dimensions')
parser.add_argument('--space_dim', type=int, default=3,
                    help='space input dimensions')
...
# env
parser.add_argument('--step_threshold', type=int, default=100000,
                    help='Number of step limit')
