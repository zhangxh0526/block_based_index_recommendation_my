        ...
        with tf.variable_scope("output", reuse=True):
            ...
            if isinstance(self.proba_distribution, CategoricalProbabilityDistribution) or isinstance(self.proba_distribution, MultiCategoricalProbabilityDistribution):
                ...
                if isinstance(self.proba_distribution, CategoricalProbabilityDistribution):
                    ...
                    action_mask_ph_concat = tf.concat([cat.action_mask_ph for cat in self.proba_distribution.categoricals], axis=1)
                    self._action_mask_ph = tf.reshape(action_mask_ph_concat, [-1, self.ac_space.nvec.prod()])
